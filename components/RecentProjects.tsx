        ...
        {projects.map(({ id, title, des, img, iconLists, link ,livelink}) => (
            <div key={id} className='sm:h-[41rem] h-[32rem] lg:min-h-[32.5rem] flex items-center justify-center sm:w-[570px] w-[80vw]'>
                <PinContainer title={link} href={link}>
                    ...
                    className="z-10 absolute bottom-0 w-full h-full border-radius:1rem " />
                    </div>
                    ...
                    <p className='lg:text-xl lg:font-normal font-light text-sm line-clamp-2'>
                      ...
                      <div className='flex items-center justify-between mt-7 mb-3'>
                        ...
                        <div className='flex justify-center items-center' >
                            <p className='flex lg:text-xl md:text-xs text-sm text-purple'><a href={livelink} target="_blank" >Check Live Site</a> </p>
