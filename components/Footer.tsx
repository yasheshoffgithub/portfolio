...
const Footer = () => {
  return (
    <footer className='w-full pb-10 mb-[100px] md:mc-5x' id='contact'>
        ...
        <div className='flex flex-col items-center'>
            <h1 className='heading lg:max-w-[45vw]'>
                Ready to take <span 
                className='text-purple'>your </span>digital 
            ...
            <a href="mailto:yps123vasu@gmail.com">
                <MagicButton
        ...
        <div className='flex mt-16 md:flex-row flex-col justify-between items-center'>
            <p className='md:text-base text-sm md:font-normal font-light'>Copyright © 2024 Yashesh</p>
        ...
        >
          <img src={profile.img} alt={`${profile.id} icon`} width={20} height={20} />
        </a>
                ))}
            </div>
        </div>
